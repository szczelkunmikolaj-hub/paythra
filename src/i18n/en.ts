const en = {
  ...
  loading: "Loading...",
  cancel: "Cancel",
  cancelSubscription: "Cancel this subscription",
  confirm: "Confirm",
  save: "Save",
  delete: "Delete",
  edit: "Edit",
  ...
  connectBankDesc: "Link your bank account to automatically detect recurring payments and subscriptions.",
  connectWithOpenBanking: "Connect with Open Banking",
  openBankingSecure: "Secure, read-only connection. We never store your credentials.",

  // Feedback
  feedbackTitle: "Send Feedback",
  feedbackPlaceholder: "Tell us what you think, what's broken, or what you'd love to see...",
  ...
  supportedFormatsPdf: "CSV, XLSX, OFX, QIF, PDF supported",
  chooseFile: "Choose File",
  smartDetectionHint: "Smart detection: only recurring payments are flagged as subscriptions.",
  unsupportedFormat: "Unsupported format",
  supportedFormatsList: "Supported: CSV, TXT, XLSX, OFX, QIF",
  supportedFormatsListPdf: "Supported: CSV, TXT, XLSX, OFX, QIF, PDF",
  fileTooLarge: "File too large",
  maxFileSize: "Maximum file size is 10MB.",
  maxFileSizePdf: "Maximum file size is 20MB.",
  pdfParsing: "Parsing PDF statement…",
  pdfParsingDesc: "Extracting transactions — this may take a few seconds.",
  pdfParsed: "Parsed {{bank}} statement — {{count}} transactions found",
  pdfGenericBank: "Bank",
  pdfNoTransactions: "No transactions found",
  pdfNoTransactionsDesc: "Could not extract any transactions from this PDF. Try exporting a CSV instead.",
  pdfParseFailed: "PDF parsing failed",
  pdfParseFailedDesc: "Could not read this PDF. Make sure it is a text-based (not scanned) bank statement.",
  ...
  termsSection4Body: "The one-time premium fee of €89.99 is non-refundable after 30 days.",
  ...
  landingTrackDescription: "Track all your monthly subscriptions in one place with Paythra.",
  landingTrackH1: "Track Monthly Subscriptions Easily",
  landingTrackIntro: "Paythra is the subscription tracker app that puts every recurring payment in one clean dashboard.",
  landingTrackSection1Heading: "See every subscription in one place",
  landingTrackSection1Body: "Stop juggling bank statements and email receipts. Paythra automatically detects recurring charges and shows you exactly what you pay, when, and to whom.",
  landingTrackSection2Heading: "Track monthly subscriptions automatically",
  landingTrackSection2Body: "Connect your accounts or import a statement and Paythra identifies the recurring patterns for you.",
  landingTrackSection3Heading: "Save money with smart insights",
  landingTrackSection3Body: "Track monthly subscriptions over time, spot price increases, and get alerted before free trials convert.",
  landingTrackSection4Heading: "Built for everyday people",
  landingTrackSection4Body: "No spreadsheets, no complex setup. Paythra is designed to be opened daily — fast, mobile-friendly, and beautifully simple.",
  landingCancelTitle: "Cancel Subscriptions Easily | Paythra",
  landingCancelDescription: "Cancel subscriptions easily and stop unwanted subscriptions for good.",
  landingCancelH1: "Cancel Subscriptions Easily",
  landingCancelIntro: "Identify the subscriptions you no longer use and stop unwanted subscriptions in just a few taps.",
  landingCancelSection1Heading: "Find the subscriptions you forgot",
  landingCancelSection1Body: "Paythra scans your transactions and surfaces every recurring charge — even the ones hiding under odd merchant names.",
  landingCancelSection2Heading: "Cancel subscriptions easily, one by one",
  landingCancelSection2Body: "Each subscription includes a direct link to the provider's cancellation page. No more digging through settings menus.",
  landingCancelSection3Heading: "Stop unwanted subscriptions before renewal",
  landingCancelSection3Body: "Get reminders before free trials end and before annual plans renew.",
  landingCancelSection4Heading: "Keep your money where it belongs",
  landingCancelSection4Body: "On average, users find unused subscriptions worth dozens of euros every month.",
  landingManagerTitle: "Personal Subscription Manager | Paythra",
  landingManagerDescription: "Paythra is your personal subscription manager for all recurring payments.",
  landingManagerH1: "Your Personal Subscription Manager",
  landingManagerIntro: "Paythra is the personal subscription manager that brings order to your recurring payments.",
  landingManagerSection1Heading: "All your recurring payments, organized",
  landingManagerSection1Body: "From Netflix to iCloud to your favorite app, Paythra categorizes everything automatically.",
  landingManagerSection2Heading: "A complete personal finance view",
  landingManagerSection2Body: "Subscriptions are quietly the biggest leak in modern budgets. Paythra brings them into the open.",
  landingManagerSection3Heading: "Smart alerts that actually help",
  landingManagerSection3Body: "Get notified about price increases, upcoming charges, and trials ending soon.",
  ...
  landingReduceDescription: "Learn how to reduce subscription costs with Paythra's smart insights.",
  landingReduceH1: "How to Reduce Subscription Costs",
  landingReduceIntro: "Paythra turns your subscription chaos into clear, actionable insights.",
  landingReduceSection1Heading: "See where your money really goes",
  landingReduceSection1Body: "Categorized spending, monthly totals, and 6 to 12 month forecasts make it easy to spot where you can save.",
  landingReduceSection2Heading: "Spot duplicates and unused services",
  landingReduceSection2Body: "Paying for two music apps? Paythra flags duplicates and unused subscriptions automatically.",
  landingReduceSection3Heading: "Get smart savings suggestions",
  landingReduceSection3Body: "Paythra recommends cheaper plans, family bundles, and annual discounts.",
  landingReduceSection4Heading: "Watch your savings grow",
  landingReduceSection4Body: "Track every cancellation and downgrade in your savings panel.",
  landingTrackerTitle: "Best Subscription Tracking App | Paythra",
  landingTrackerDescription: "Paythra is the subscription tracking app that tracks subscriptions automatically.",
  landingTrackerH1: "The Best Subscription Tracking App",
  landingTrackerIntro: "Track subscriptions automatically with Paythra.",
  landingTrackerSection1Heading: "Track subscriptions automatically",
  landingTrackerSection1Body: "Paythra detects recurring payments from your transactions or email receipts.",
  landingTrackerSection2Heading: "Simple, modern, beautifully designed",
  landingTrackerSection2Body: "A clean dashboard, dark mode, and mobile-first design.",
  landingTrackerSection3Heading: "Built for real life",
  landingTrackerSection3Body: "Multi-currency support, custom categories, and a payment calendar.",
  landingTrackerSection4Heading: "Free to start, premium when you need more",
  landingTrackerSection4Body: "Start tracking subscriptions for free, upgrade only if you want advanced insights.",
  landingTrackProblemBody: "Most people lose track of how many subscriptions they actually pay for.",
  landingCancelProblemBody: "Cancelling subscriptions is intentionally hard. Buried settings, retention flows, forgotten free trials.",
  landingManagerProblemBody: "Without a personal subscription manager, recurring payments live across emails, app stores, banks and memory.",
  landingReduceProblemBody: "Subscriptions are the silent killers of modern budgets.",
  landingTrackerProblemBody: "Manual spreadsheets and bank apps weren't built to track subscriptions.",
  ...
  homeSeoDescription: "Track, manage, and cancel your subscriptions easily.",
};
